...
class CC_DLL TowerdefensePlayer : public CCObject
{
public:
...
private:
    static TowerdefensePlayer *s_sharedInstance;
    static TowerdefensePlayer *sharedInstance(void);
    static void purgeSharedInstance(void);

    TowerdefensePlayer(void);
