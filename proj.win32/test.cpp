    ...
    int       nCmdShow)
{
    ...
    return TestPlayer::createAndRun();
}

int TestPlayer::createAndRun(void)
{
    TestPlayer *host = TestPlayer::sharedInstance();
    int ret = host->run();
    TestPlayer::purgeSharedInstance();
    return ret;
}

TestPlayer *TestPlayer::s_sharedInstance = NULL;

TestPlayer *TestPlayer::sharedInstance(void)
{
    if (!s_sharedInstance)
    {
        s_sharedInstance = new TestPlayer();
    }
    return s_sharedInstance;
}

void TestPlayer::purgeSharedInstance(void)
{
    if (s_sharedInstance)
    {
...
int TestPlayer::run(void)
{
    ...
    do
    {
        ...
        SetWindowTextA(m_hwnd, "test-player");
...
void TestPlayer::loadProjectConfig(void)
{
    vector<string> args;
...
void TestPlayer::createViewMenu(void)
{
...
void TestPlayer::updateMenu(void)
{
    HMENU menu = GetMenu(m_hwnd);
    HMENU viewMenu = GetSubMenu(menu, 1);
...
void TestPlayer::updateWindowTitle(void)
{
}

void TestPlayer::relaunch(void)
{
...
void TestPlayer::writeDebugLog(const char *log)
{
...
// menu callback
void TestPlayer::onFileOpenProject(void)
{
...
void TestPlayer::onFileCreateProjectShortcut(void)
{
    ...
    if (SUCCEEDED(hres))
    {
        ...
        psl->SetDescription(L"TestPlayer");
...
void TestPlayer::onFileProjectConfig(void)
{
...
void TestPlayer::onFileRelaunch(void)
{
    relaunch();
}

void TestPlayer::onFileExit(void)
{
    DestroyWindow(m_hwnd);
}

void TestPlayer::onViewChangeFrameSize(int viewMenuID)
{
...
void TestPlayer::onViewChangeOrientation(int viewMenuID)
{
    bool isLandscape = m_project.isLandscapeFrame();
...
void TestPlayer::onViewChangeZoom(int scaleMode)
{
    float scale = 1.0f;
...
void TestPlayer::onHelpAbout(void)
{
    DialogBox(GetModuleHandle(NULL), MAKEINTRESOURCE(IDD_ABOUTBOX), m_hwnd, AboutDialogCallback);
}

// windows callback
LRESULT TestPlayer::WindowProc(UINT message, WPARAM wParam, LPARAM lParam, BOOL* pProcessed)
{
    int wmId, wmEvent;
    TestPlayer *host = TestPlayer::sharedInstance();
...
INT_PTR CALLBACK TestPlayer::AboutDialogCallback(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
