    ...
    int       nCmdShow)
{
    ...
    return TowerdefensePlayer::createAndRun();
}

int TowerdefensePlayer::createAndRun(void)
{
    TowerdefensePlayer *host = TowerdefensePlayer::sharedInstance();
    int ret = host->run();
    TowerdefensePlayer::purgeSharedInstance();
    return ret;
}

TowerdefensePlayer *TowerdefensePlayer::s_sharedInstance = NULL;

TowerdefensePlayer *TowerdefensePlayer::sharedInstance(void)
{
    if (!s_sharedInstance)
    {
        s_sharedInstance = new TowerdefensePlayer();
    }
    return s_sharedInstance;
}

void TowerdefensePlayer::purgeSharedInstance(void)
{
    if (s_sharedInstance)
    {
...
TowerdefensePlayer::TowerdefensePlayer(void)
: m_app(NULL)
, m_hwnd(NULL)
, m_exit(TRUE)
...
int TowerdefensePlayer::run(void)
{
    ...
    do
    {
        ...
        SetWindowTextA(m_hwnd, "towerdefense-player");
...
void TowerdefensePlayer::loadProjectConfig(void)
{
    vector<string> args;
...
void TowerdefensePlayer::createViewMenu(void)
{
...
void TowerdefensePlayer::updateMenu(void)
{
    HMENU menu = GetMenu(m_hwnd);
    HMENU viewMenu = GetSubMenu(menu, 1);
...
void TowerdefensePlayer::updateWindowTitle(void)
{
}

void TowerdefensePlayer::relaunch(void)
{
...
void TowerdefensePlayer::writeDebugLog(const char *log)
{
...
// menu callback
void TowerdefensePlayer::onFileOpenProject(void)
{
...
void TowerdefensePlayer::onFileCreateProjectShortcut(void)
{
    ...
    if (SUCCEEDED(hres))
    {
        ...
        psl->SetDescription(L"TowerdefensePlayer");
...
void TowerdefensePlayer::onFileProjectConfig(void)
{
...
void TowerdefensePlayer::onFileRelaunch(void)
{
    relaunch();
}

void TowerdefensePlayer::onFileExit(void)
{
    DestroyWindow(m_hwnd);
}

void TowerdefensePlayer::onViewChangeFrameSize(int viewMenuID)
{
...
void TowerdefensePlayer::onViewChangeOrientation(int viewMenuID)
{
    bool isLandscape = m_project.isLandscapeFrame();
...
void TowerdefensePlayer::onViewChangeZoom(int scaleMode)
{
    float scale = 1.0f;
...
void TowerdefensePlayer::onHelpAbout(void)
{
    DialogBox(GetModuleHandle(NULL), MAKEINTRESOURCE(IDD_ABOUTBOX), m_hwnd, AboutDialogCallback);
}

// windows callback
LRESULT TowerdefensePlayer::WindowProc(UINT message, WPARAM wParam, LPARAM lParam, BOOL* pProcessed)
{
    int wmId, wmEvent;
    TowerdefensePlayer *host = TowerdefensePlayer::sharedInstance();
...
INT_PTR CALLBACK TowerdefensePlayer::AboutDialogCallback(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
